...
class ContextManager {
  ...
  assembleContextRoleplayMode(
    ...
    const separator = "\n# Current conversation progress: \n";
    const footer =
      "\n\n# It's assistant's turn to reply and You only need to send reply for this round of conversation.remember,you are now in role-playing mode, acting out the character and scene base on the previous document. Do not use third-person narration, but always give a detailed, imaginative response in the first person:\n\n";
